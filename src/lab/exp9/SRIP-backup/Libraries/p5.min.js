...
! function (e) {
    ...
    return function o(a, s, h) {
        ...
        4: [function (z, r, i) {
            (function (G, V) {
                ...
                e = this, t = function () {
                    ...
                    function L(e, t) {
                        var r, i;
                        e === t ? A(e, new TypeError("You cannot resolve a promise with itself")) : (i = typeof (r = t), null === r || "object" !== i && "function" !== i ? D(e, t) : R(e, t, C(t)))
                    }
        ...
        8: [function (e, t, r) {
            ...
            function U(e, t, r, i, n, o) {
                ...
                for (null === n && (n = ce(t).a.b.c);
                    (r = (i = ce(t)).a.b).a === n.a;) r.c !== n && (T(J(r), r), T(J(n), r)), i.f = t.f - r.f, i.d = A(e, i.f), t.b = !0, !a && F(e, t) && (R(r, n), L(t), c(n)), a = !1, t = i, n = r;
                t.b = !0, o && V(e, t)
            }
            ...
            function V(e, t) {
                for (var r = ce(t);;) {
                    ...
                    if (i && (r.c ? (L(r), c(o), o = (r = ce(t)).a) : t.c && (L(t), c(n), n = (t = pe(r)).a)), n.a !== o.a)
                        if (n.b.a === o.b.a || t.c || r.c || n.b.a !== e.a && o.b.a !== e.a) F(e, t);
                        else if (G(e, t)) break;
            ...
            (function (Gr) {
                ...
                e = this,
                    function (M) {
                        ...
                        var N, F = "function" == typeof WeakMap && new WeakMap;
                        ...
                        k.MACSTRING = function (e, t) {
                            ...
                            var r = [];
                            if (Array.isArray(t))
                                for (var i = 0; i < t.length; i += 1) P.argument(e.length === t.length, "Not enough arguments given for type" + t), r = r.concat(k.OPERAND(e[i], t[i]));
                                ...
                                for (var r, i, n, o, a, s, h, l, u, c, p, d, f = 0; f < t.length;) {
                                    ...
                                    switch (f += 1, m) {
                                        ...
                                        case 4:
                                            ...
                                            break;
                                        case 5:
                                            for (; 0 < E.length;) P += E.shift(), D += E.shift(), M.lineTo(P, D);
                                            break;
                                        case 6:
                                            for (; 0 < E.length && (P += E.shift(), M.lineTo(P, D), 0 !== E.length);) D += E.shift(), M.lineTo(P, D);
                                            break;
                                        case 7:
                                            for (; 0 < E.length && (D += E.shift(), M.lineTo(P, D), 0 !== E.length);) P += E.shift(), M.lineTo(P, D);
                                            break;
                                        case 8:
                                            for (; 0 < E.length;) y = P + E.shift(), b = D + E.shift(), _ = y + E.shift(), x = b + E.shift(), P = _ + E.shift(), D = x + E.shift(), M.curveTo(y, b, _, x, P, D);
                                            break;
                                        case 10:
                                            a = E.pop() + S, (s = w[a]) && e(s);
                                            break;
                                        ...
                                        case 23:
                                            ...
                                            break;
                                        case 24:
                                            for (; 2 < E.length;) y = P + E.shift(), b = D + E.shift(), _ = y + E.shift(), x = b + E.shift(), P = _ + E.shift(), D = x + E.shift(), M.curveTo(y, b, _, x, P, D);
                                            P += E.shift(), D += E.shift(), M.lineTo(P, D);
                                            break;
                                        case 25:
                                            for (; 6 < E.length;) P += E.shift(), D += E.shift(), M.lineTo(P, D);
                                            y = P + E.shift(), b = D + E.shift(), _ = y + E.shift(), x = b + E.shift(), P = _ + E.shift(), D = x + E.shift(), M.curveTo(y, b, _, x, P, D);
                                            break;
                                        case 26:
                                            for (E.length % 2 && (P += E.shift()); 0 < E.length;) y = P, b = D + E.shift(), _ = y + E.shift(), x = b + E.shift(), P = _, D = x + E.shift(), M.curveTo(y, b, _, x, P, D);
                                            break;
                                        case 27:
                                            for (E.length % 2 && (D += E.shift()); 0 < E.length;) y = P + E.shift(), b = D, _ = y + E.shift(), x = b + E.shift(), P = _ + E.shift(), D = x, M.curveTo(y, b, _, x, P, D);
                                            break;
                                        case 28:
                                        ...
                                        case 29:
                                            ...
                                            break;
                                        case 30:
                                            for (; 0 < E.length && (y = P, b = D + E.shift(), _ = y + E.shift(), x = b + E.shift(), P = _ + E.shift(), D = x + (1 === E.length ? E.shift() : 0), M.curveTo(y, b, _, x, P, D), 0 !== E.length);) y = P + E.shift(), b = D, _ = y + E.shift(), x = b + E.shift(), D = x + E.shift(), P = _ + (1 === E.length ? E.shift() : 0), M.curveTo(y, b, _, x, P, D);
                                            break;
                                        case 31:
                                            for (; 0 < E.length && (y = P + E.shift(), b = D, _ = y + E.shift(), x = b + E.shift(), D = x + E.shift(), P = _ + (1 === E.length ? E.shift() : 0), M.curveTo(y, b, _, x, P, D), 0 !== E.length);) y = P, b = D + E.shift(), _ = y + E.shift(), x = b + E.shift(), P = _ + E.shift(), D = x + (1 === E.length ? E.shift() : 0), M.curveTo(y, b, _, x, P, D);
                                            break;
                                        default:
                        ...
                        var gt = {
                            ...
                            fontToTable: function (e) {
                                ...
                                L || (L = E.replace(/\s/g, "") + "-" + C);
                                var P = {};
                                for (var D in e.names) P[D] = e.names[D];
                        ...
                        Nt.prototype.exec = function (e, t) {
                            ...
                            var n = e.ip,
                                o = e.prog;
                            e.prog = e.funcs[r];
                            for (var a = 0; a < i; a++) It(e), M.DEBUG && console.log(++e.step, a + 1 < i ? "next loopcall" : "done loopcall", a);
                            e.ip = n, e.prog = o
                        }, function (e) {
                            var t = e.stack.pop();
        ...
        41: [function (e, t, r) {
            ...
            function i(e, t) {
                for (var r, i, n, o, a, s, h, l, u, c, p = A._toPixels(e), d = e.width, f = e.height, m = d * f, v = new Int32Array(m), g = 0; g < m; g++) v[g] = A._getARGB(p, g);
                ...
                for (function (e) {
                        ...
                        if (R !== (t = t < 1 ? 1 : t < 248 ? t : 248)) {
                            ...
                            for (var r = 0; r < L; r++) D[r] = new Int32Array(256);
                ...
                for (u = (l = -R) * d, b = E = 0; b < f; b++) {
                    for (y = 0; y < d; y++) {
                        ...
                        for (_ = c; _ < L && !(f <= h); _++) a += (x = D[_])[w[s]], i += x[S[s]], n += x[T[s]], o += x[M[s]], r += P[_], h++, s += d;
        ...
        46: [function (s, e, t) {
            ...
            s("../core/error_helpers"), v.prototype.loadJSON = function () {
                ...
                var l = arguments.length - a,
                    u = arguments[0];
                if (2 === l && "string" == typeof u && "object" == typeof arguments[1]) r = new Request(u, arguments[1]), e = arguments[2], t = arguments[3];
                else {
                ...
                if (0 !== i.length)
                    if (i[0] instanceof v.Renderer || i[0] instanceof v.Graphics) v.prototype.saveCanvas(i[0].elt, i[1], i[2]);
                    else if (1 === i.length && "string" == typeof i[0]) v.prototype.saveCanvas(n, i[0]);
        ...
        70: [function (e, t, r) {
            ...
            "undefined" != typeof Float32Array && (i = Float32Array, D = function (e) {
